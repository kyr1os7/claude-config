...
7. Field standar lain: `interviewPlace`="Web", `interviewMethod`=["メール","オンラインMTG"], `timeInterview`="日々の面談", `personInCharge`(テンプレート)="支援担当". Lookup WOID/HRID/COID dari App 13 by `name`.
